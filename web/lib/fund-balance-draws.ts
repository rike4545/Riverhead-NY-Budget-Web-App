...
export const limits = [
  ...
  'One draw is reported and deliberately not netted against the unassigned cushion: resolution 2026-361 charges Assigned Unappropriated Fund Balance for Community Benefit Funds. Real money and a real vote, but it does not come out of the tier the reserve policy measures.',

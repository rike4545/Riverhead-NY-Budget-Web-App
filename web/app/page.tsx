...
export default function Page() {
  return (
    ...
    >
      {/* Single "start here" banner — the 10-stop tour, with the plain-English
      ...
      <div style={{
        ...
        <div style={{ minWidth: 240 }}>
          ...
          <div style={{ color: '#cbdcec', fontSize: 14.5 }}>
            A 10-stop, plain-English walkthrough — from “what is the budget?” to the raw data. Prefer definitions first?{' '}

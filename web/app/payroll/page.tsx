...
export default function PayrollPage() {
  return (
    ...
    >
      <PlainCallout
        tips={[
          { label: 'Three views', text: 'use the tabs below — "Actual Pay" is what employees were really paid (2018–2025); "Authorized Salary" is the base pay the Board set for 2025; "Raises 2025→2026" shows who got a raise and by how much.' },

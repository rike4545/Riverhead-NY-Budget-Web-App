...
- **Fund-balance policy:** Resolution 918 of Dec. 20, 2011 (amending Res. 1101 of Dec. 5, 2006): a 15% floor on the General Fund's *total* balance incl. reserves vs. the total operating budget, **no ceiling**, and three permitted uses for money above 15% (next year's tax reduction, one-time capital, natural emergencies). The 2011 rewrite dropped the 2006 promise that after a draw below 15% the Town "would immediately begin" rebuilding to it; going below now takes only a Board resolution. Nearby towns' written rules — Brookhaven 25% with a three-year rebuild and a surplus split set by Town law, Southampton 17% in its Town Code with at least 75% of each year's surplus sent to capital, East Hampton a 20% goal, Southold and Huntington 10%, Smithtown 5–10% — are in `web/lib/fund-balance-policies.ts`, each quote checked against its source at build time. There is **no 20% target** in any Town record; the tabled Nov. 2011 draft (Res. 833) had a 10% minimum; the app presents 25–32%
